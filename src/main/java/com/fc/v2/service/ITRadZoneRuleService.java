...
/**
 * 分区驻留剂量判定规则 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITRadZoneRuleService {

    /** 按主键查询规则 */
    TRadZoneRule selectTRadZoneRuleById(Long id);
    ...
    List<TRadZoneRule> listAvailable(Date at);
