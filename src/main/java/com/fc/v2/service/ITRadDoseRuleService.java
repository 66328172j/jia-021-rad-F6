...
/**
 * 工作场所剂量率判定规则 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITRadDoseRuleService {

    /** 按主键查询规则 */
    TRadDoseRule selectTRadDoseRuleById(Long id);
    ...
    List<TRadDoseRule> listAvailable(Date at);
