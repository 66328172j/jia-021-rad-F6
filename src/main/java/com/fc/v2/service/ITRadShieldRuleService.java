...
/**
 * 屏蔽体核算判定规则 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITRadShieldRuleService {

    /** 按主键查询规则 */
    TRadShieldRule selectTRadShieldRuleById(Long id);
    ...
    List<TRadShieldRule> listAvailable(Date at);
