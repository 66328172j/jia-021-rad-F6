...
/**
 * 工作场所剂量率判定规则对象 t_rad_dose_rule
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_rad_dose_rule")
@ApiModel(value = "TRadDoseRule", description = "工作场所剂量率判定规则")
public class TRadDoseRule implements Serializable {
    ...
    /** 剂量率正常档上限(μSv/h) */
    @TableField("th1_max")
    @ApiModelProperty(value = "剂量率正常档上限(μSv/h)")
    private BigDecimal th1Max;

    /** 剂量率关注档上限(μSv/h) */
    @TableField("th2_max")
    @ApiModelProperty(value = "剂量率关注档上限(μSv/h)")
    private BigDecimal th2Max;

    /** 剂量率管控档上限(μSv/h) */
    @TableField("th3_max")
    @ApiModelProperty(value = "剂量率管控档上限(μSv/h)")
