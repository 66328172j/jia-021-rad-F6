...
/**
 * 屏蔽改造方案对象 t_rad_shield_plan
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_rad_shield_plan")
@ApiModel(value = "TRadShieldPlan", description = "屏蔽改造方案")
public class TRadShieldPlan implements Serializable {
